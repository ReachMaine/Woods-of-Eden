...
$background = 'url('.get_stylesheet_directory_uri().'/images/canvas.jpg) no-repeat scroll center center';
...
$hero_section_custom_height = "96";
?>

<div class = "zig header-hero-section be-wide-single be-blog-<?php echo $blog_loop_style; ?>" id = "hero-section">
    <div class = "header-hero-custom-section">
        <div class = "hero-section-wrap be-section be-bg-overlay be-bg-cover clearfix <?php echo $full; ?>" style = "background:<?php echo $background; ?>;<?php echo ( ( '' == $full ) ? ( ' height:initial; ' ) : '' ); ?>">
            <?php /* zig xout over lay <div class = "section-overlay"></div> */ ?>
            <div class = "be-row be-wrap">
                <div class = "hero-section-inner-wrap">
                    <div class = "hero-section-inner">
                        <?php /* zig xout category stuff
                            if( !empty( $cats ) ) :
                        ?>
                        ...
                        <div class = "hero-section-blog-title">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri();?>/images/fir-bough.png">
                        </div>
                        <?php /* zig xout meta  <div class = "hero-section-blog-bottom-meta-wrap">
                            <?php
                                if( !empty( $post_date ) ) :
                            ?>
